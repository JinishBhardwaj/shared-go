...
func (b *AuthenticationBuilder) WithCognito(ctx context.Context, opts CognitoOptions) *AuthenticationBuilder {
	...
	validator, err := NewOIDCValidator(ctx, OIDCValidatorConfig{
		...
		Normalizer:           NewCognitoClaimsNormalizer(),
...
func (b *AuthenticationBuilder) WithClaimsTransformation(transformer ClaimsTransformer) *AuthenticationBuilder {
	b.claimsTransformer = transformer
	return b
}

// AddClaimsTransformation is an alias for WithClaimsTransformation.
func (b *AuthenticationBuilder) AddClaimsTransformation(transformer ClaimsTransformer) *AuthenticationBuilder {
