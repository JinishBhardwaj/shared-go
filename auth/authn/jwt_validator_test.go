...
func TestJWTValidator_Flows(t *testing.T) {
	...
	tests := []struct {
		...
		expectedMethod principal.AuthMethod
		expectedSub    string
	...
	}{
		{
			...
			expectedMethod: principal.AuthMethodAuthCodePKCE,
		...
		},
		{
			...
			expectedMethod: principal.AuthMethodClientCredentials,
		...
		},
		{
			...
			expectedMethod: principal.AuthMethodDeviceFlow,
